...
export default function Stepper({
  ...
  return (
    ...
    >
      <div
        className={`mx-auto w-full max-w-md bg-black/50 rounded-4xl shadow-xl ${stepCircleContainerClassName}`}
...
export function Step({ children }: StepProps) {
  return <div className="px-8 flex flex-col items-center">{children}</div>;
}
